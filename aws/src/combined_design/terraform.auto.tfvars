...
vpcs = {
  ...
  security_vpc = {
    ...
    subnets = {
      ...
      "10.100.0.0/24"  = { az = "us-west-1a", set = "mgmt", nacl = null }
      "10.100.64.0/24" = { az = "us-west-1b", set = "mgmt", nacl = null }
      "10.100.1.0/24"  = { az = "us-west-1a", set = "private", nacl = "trusted_path_monitoring" }
      "10.100.65.0/24" = { az = "us-west-1b", set = "private", nacl = "trusted_path_monitoring" }
      "10.100.2.0/24"  = { az = "us-west-1a", set = "public", nacl = null }
      "10.100.66.0/24" = { az = "us-west-1b", set = "public", nacl = null }
      "10.100.3.0/24"  = { az = "us-west-1a", set = "tgw_attach", nacl = null }
      "10.100.67.0/24" = { az = "us-west-1b", set = "tgw_attach", nacl = null }
      "10.100.4.0/24"  = { az = "us-west-1a", set = "gwlbe_outbound", nacl = null }
      "10.100.68.0/24" = { az = "us-west-1b", set = "gwlbe_outbound", nacl = null }
      "10.100.5.0/24"  = { az = "us-west-1a", set = "gwlb", nacl = null }
      "10.100.69.0/24" = { az = "us-west-1b", set = "gwlb", nacl = null }
      "10.100.10.0/24" = { az = "us-west-1a", set = "gwlbe_eastwest", nacl = null }
      "10.100.74.0/24" = { az = "us-west-1b", set = "gwlbe_eastwest", nacl = null }
    }
    routes = {
  ...
  app1_vpc = {
    ...
    subnets = {
      # Do not modify value of `set=`, it is an internal identifier referenced by main.tf.
      "10.104.0.0/24"   = { az = "us-west-1a", set = "app1_vm", nacl = null }
      "10.104.128.0/24" = { az = "us-west-1b", set = "app1_vm", nacl = null }
      "10.104.2.0/24"   = { az = "us-west-1a", set = "app1_lb", nacl = null }
      "10.104.130.0/24" = { az = "us-west-1b", set = "app1_lb", nacl = null }
      "10.104.3.0/24"   = { az = "us-west-1a", set = "app1_gwlbe", nacl = null }
      "10.104.131.0/24" = { az = "us-west-1b", set = "app1_gwlbe", nacl = null }
    }
    routes = {
      # Value of `vpc_subnet` is built from key of VPCs concatenate with `-` and key of subnet in format: `VPCKEY-SUBNETKEY`
      # Value of `next_hop_key` must match keys use to create TGW attachment, IGW, GWLB endpoint or other resources
  ...
  app2_vpc = {
    ...
    subnets = {
      # Do not modify value of `set=`, it is an internal identifier referenced by main.tf.
      "10.105.0.0/24"   = { az = "us-west-1a", set = "app2_vm", nacl = null }
      "10.105.128.0/24" = { az = "us-west-1b", set = "app2_vm", nacl = null }
      "10.105.2.0/24"   = { az = "us-west-1a", set = "app2_lb", nacl = null }
      "10.105.130.0/24" = { az = "us-west-1b", set = "app2_lb", nacl = null }
      "10.105.3.0/24"   = { az = "us-west-1a", set = "app2_gwlbe", nacl = null }
      "10.105.131.0/24" = { az = "us-west-1b", set = "app2_gwlbe", nacl = null }
    }
    routes = {
      # Value of `vpc_subnet` is built from key of VPCs concatenate with `-` and key of subnet in format: `VPCKEY-SUBNETKEY`
      # Value of `next_hop_key` must match keys use to create TGW attachment, IGW, GWLB endpoint or other resources
